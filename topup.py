    ...
    async with user_locks[tg_id]:
        ...
        try:
            ...
            if "login" in str(res.url).lower() or res.status_code in [403, 503]: 
                ...
                success = await auto_login_and_get_cookie(bot_id)
                if not success and bot_id == bot.id: 
            ...
            if code_status in ['200', '201', '0', '1'] or 'success' in str(check_res.get('msg', '')).lower():
                ...
                if pay_status in ['200', '0', '1'] or 'success' in str(pay_res.get('msg', '')).lower():
                    ...
                    if added_amount <= 0 and card_amount > 0: 
                        added_amount = card_amount
...
async def handle_check_region(message: types.Message):
    ...
    try:
        ...
        country_map = {
            ...
            "BR": "Brazil", "US": "United States", "CA": "Canada", "MX": "Mexico",
            ...
            "PR": "Puerto Rico", "JM": "Jamaica", "HT": "Haiti", "BS": "Bahamas",
            "TT": "Trinidad and Tobago", "ZA": "South Africa", "EG": "Egypt",
            "NG": "Nigeria", "KE": "Kenya", "TZ": "Tanzania", "UG": "Uganda",
            "RW": "Rwanda", "ET": "Ethiopia", "GH": "Ghana", "SN": "Senegal",
            "CI": "Ivory Coast", "MA": "Morocco", "TN": "Tunisia", "DZ": "Algeria",
            "LY": "Libya", "SD": "Sudan", "SS": "South Sudan", "ZM": "Zambia",
            "ZW": "Zimbabwe", "MW": "Malawi", "MZ": "Mozambique", "AO": "Angola",
            "NA": "Namibia", "BW": "Botswana", "MG": "Madagascar", "MU": "Mauritius",
...
async def send_help_message(message: types.Message):
    ...
    help_text = (
        ...
        f"🔹 <code>.listmb</code>    : MCC BR ဈေးနှုန်းစာရင်း ကြည့်ရန်\n"
        f"🔹 <code>.listmp</code>    : MCC PH ဈေးနှုန်းစာရင်း ကြည့်ရန်\n"
